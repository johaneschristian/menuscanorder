  ...
  <div class="row flex-md-row flex-column">
    <div class="col w-mdc-17 w-100">
      <div class="sidebar container-fluid text-white p-3">
        <div class="navbar d-flex flex-row justify-content-between">
          <h4 class="sidebar-title logo mt-3 text-center">
            <?= $this->renderSection('business_name') ?>
          </h4>
          <button class="navbar-toggler sidebar-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#sidebar-collapse" aria-controls="navbarNav" aria-expanded="true" aria-label="Toggle navigation">
        ...
        <div class="navbar-collapse collapse" id="sidebar-collapse">
          ...
          <div class="sidebar-links">
            ...
            <a href="<?= base_url('business/orders') ?>">
              <span class="icon">
            ...
            <a href="<?= base_url('business/orders/kitchen-view') ?>">
              <span class="icon">
            ...
            <a href="<?= base_url('business/seat-management') ?>">
              <span class="icon">
            ...
            <a href="<?= base_url('business/profile') ?>">
              <span class="icon">
    ...
    <div class="col-auto w-mdc-83 w-100">
      <?php if (session()->getFlashData('success')) : ?>
        <div class="alert alert-success w-75 ms-auto me-auto mt-3"><?= esc(session()->getFlashData('success')) ?></div>
      <?php endif; ?>

      <?php if (session()->getFlashData('error')) : ?>
        <div class="alert alert-danger w-75 ms-auto me-auto mt-3"><?= esc(session()->getFlashData('error')) ?></div>
      <?php endif; ?>
