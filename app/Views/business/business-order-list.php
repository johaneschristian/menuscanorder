...
<body>
  <div class="row flex-md-row flex-column p-0">
      ...
      <div class="p-5">
        <div class="card shadow mb-3 ps-3 pe-3 pb-3 row d-flex flex-row justify-content-between align-items-center">
          <div class="input-group mt-3 me-3 w-mdc-50 w-100">
            <input type="text" class="form-control bg-soft-gray" placeholder="Search Table Number">
        ...
        <div class="card clickable w-100 p-3 mt-3 shadow-sm">
          <div class="row fw-bold d-flex flex-md-row flex-column align-items-md-center align-items-start">
            ...
            <div class="col-md-2 mt-md-0 mt-2 d-flex flex-md-column flex-row-reverse justify-content-end">
              <div class="row">
                <span class="d-md-block d-none">12</span>
              </div>
              <div class="row">
                <div>
                  <span class="sub-text text-muted d-md-block d-none">Starbucks Taman Galaxi</span>
                  <span class="d-md-none d-block">Starbucks Taman Galaxi, Table 12</span>
                </div>
                <div class="sub-text text-muted d-md-none w-auto">Outlet, Table Number</div>
              </div>
            </div>
