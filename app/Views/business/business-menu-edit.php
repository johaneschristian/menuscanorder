    ...
    <div class="row flex-md-row flex-column">
      ...
      <div class="col-auto w-mdc-83 w-100">
        ...
        <div class="p-5 d-flex flex-column align-items-center">
          ...
          <form id="menu-item-form" action="" method="post" enctype="multipart/form-data" class="w-100 d-flex flex-md-row flex-column justify-content-center gap-3">
            <div class="w-mdc-25 w-100">
              <div class="card shadow">
                <img src="" alt="" srcset="" id="menu-item-image-preview" class="rounded" style="min-height: 300px; max-height: 400px;">
              </div>
            ...
            <card class="card shadow w-mdc-50 w-100 p-3">
              <div class="mb-3">
                ...
                <input type="text" name="product_name" class="form-control bg-soft-gray" placeholder="Enter menu name here" value="Nasi Goreng">
              </div>
              <label for="" class="form-label fw-bold">Price</label>
              <div class="input-group mb-3">
                <span class="input-group-text">AUD</span>
                <input type="number" step="any" name="product_price" class="form-control bg-soft-gray" placeholder="Enter price here" value="15.00">
              </div>
              <div class="mb-3">
                <label for="" class="form-label fw-bold lh-sm">Category</label>
                <select name="product_category" class="form-select bg-soft-gray">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control bg-soft-gray" id="description" name="product_description" rows="3" placeholder="Enter description here">Indonesian traditional food.</textarea>
              </div>
              ...
              <div class="d-flex flex-row justify-content-end gap-1">
                <button type="button" class="btn btn-warning">Update My Product</button>
